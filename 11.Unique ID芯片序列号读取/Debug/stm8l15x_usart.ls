 ...
 162                     ; 142 void USART_DeInit(USART_TypeDef* USARTx)
 162                     ; 143 {
 164                     	switch	.text
 165  0000               _USART_DeInit:
 169                     ; 147   (void) USARTx->SR;
 171  0000 f6            	ld	a,(x)
 172                     ; 148   (void) USARTx->DR;
 174  0001 e601          	ld	a,(1,x)
 175                     ; 150   USARTx->BRR2 = USART_BRR2_RESET_VALUE;  /* Set USART_BRR2 to reset value 0x00 */
 177  0003 6f03          	clr	(3,x)
 178                     ; 151   USARTx->BRR1 = USART_BRR1_RESET_VALUE;  /* Set USART_BRR1 to reset value 0x00 */
 180  0005 6f02          	clr	(2,x)
 181                     ; 153   USARTx->CR1 = USART_CR1_RESET_VALUE;  /* Set USART_CR1 to reset value 0x00 */
 183  0007 6f04          	clr	(4,x)
 184                     ; 154   USARTx->CR2 = USART_CR2_RESET_VALUE;  /* Set USART_CR2 to reset value 0x00 */
 186  0009 6f05          	clr	(5,x)
 187                     ; 155   USARTx->CR3 = USART_CR3_RESET_VALUE;  /* Set USART_CR3 to reset value 0x00 */
 189  000b 6f06          	clr	(6,x)
 190                     ; 156   USARTx->CR4 = USART_CR4_RESET_VALUE;  /* Set USART_CR4 to reset value 0x00 */
 192  000d 6f07          	clr	(7,x)
 193                     ; 157 }
 196  000f 81            	ret
 388                     ; 186 void USART_Init(USART_TypeDef* USARTx, uint32_t BaudRate, USART_WordLength_TypeDef
 388                     ; 187                 USART_WordLength, USART_StopBits_TypeDef USART_StopBits,
 388                     ; 188                 USART_Parity_TypeDef USART_Parity,  USART_Mode_TypeDef USART_Mode)
 388                     ; 189 {
 389                     	switch	.text
 ...
 397                     ; 190   uint32_t BaudRate_Mantissa = 0;
 399                     ; 193   assert_param(IS_USART_BAUDRATE(BaudRate));
 401                     ; 195   assert_param(IS_USART_WORDLENGTH(USART_WordLength));
 403                     ; 197   assert_param(IS_USART_STOPBITS(USART_StopBits));
 405                     ; 199   assert_param(IS_USART_PARITY(USART_Parity));
 407                     ; 201   assert_param(IS_USART_MODE(USART_Mode));
 409                     ; 204   USARTx->CR1 &= (uint8_t)(~(USART_CR1_PCEN | USART_CR1_PS | USART_CR1_M));
 411  0013 e604          	ld	a,(4,x)
 412  0015 a4e9          	and	a,#233
 413  0017 e704          	ld	(4,x),a
 414                     ; 207   USARTx->CR1 |= (uint8_t)((uint8_t)USART_WordLength | (uint8_t)USART_Parity);
 416  0019 7b0d          	ld	a,(OFST+9,sp)
 417  001b 1a0f          	or	a,(OFST+11,sp)
 418  001d ea04          	or	a,(4,x)
 419  001f e704          	ld	(4,x),a
 420                     ; 210   USARTx->CR3 &= (uint8_t)(~USART_CR3_STOP);
 422  0021 e606          	ld	a,(6,x)
 423  0023 a4cf          	and	a,#207
 424  0025 e706          	ld	(6,x),a
 425                     ; 212   USARTx->CR3 |= (uint8_t)USART_StopBits;
 427  0027 e606          	ld	a,(6,x)
 428  0029 1a0e          	or	a,(OFST+10,sp)
 429  002b e706          	ld	(6,x),a
 430                     ; 215   USARTx->BRR1 &= (uint8_t)(~USART_BRR1_DIVM);
 432  002d 6f02          	clr	(2,x)
 433                     ; 217   USARTx->BRR2 &= (uint8_t)(~USART_BRR2_DIVM);
 435  002f e603          	ld	a,(3,x)
 436  0031 a40f          	and	a,#15
 437  0033 e703          	ld	(3,x),a
 438                     ; 219   USARTx->BRR2 &= (uint8_t)(~USART_BRR2_DIVF);
 440  0035 e603          	ld	a,(3,x)
 441  0037 a4f0          	and	a,#240
 442  0039 e703          	ld	(3,x),a
 443                     ; 221   BaudRate_Mantissa  = (uint32_t)(CLK_GetClockFreq() / BaudRate );
 ...
 456                     ; 223   USARTx->BRR2 = (uint8_t)((BaudRate_Mantissa >> (uint8_t)8) & (uint8_t)0xF0);
 458  004c 7b03          	ld	a,(OFST-1,sp)
 459  004e a4f0          	and	a,#240
 460  0050 1e05          	ldw	x,(OFST+1,sp)
 461  0052 e703          	ld	(3,x),a
 462                     ; 225   USARTx->BRR2 |= (uint8_t)(BaudRate_Mantissa & (uint8_t)0x0F);
 ...
 469                     ; 227   USARTx->BRR1 = (uint8_t)(BaudRate_Mantissa >> (uint8_t)4);
 ...
 497  0082 81            	ret
 657                     ; 258 void USART_ClockInit(USART_TypeDef* USARTx, USART_Clock_TypeDef USART_Clock,
 657                     ; 259                      USART_CPOL_TypeDef USART_CPOL, USART_CPHA_TypeDef USART_CPHA,
 657                     ; 260                      USART_LastBit_TypeDef USART_LastBit)
 657                     ; 261 {
 658                     	switch	.text
 659  0083               _USART_ClockInit:
 661  0083 89            	pushw	x
 662       00000000      OFST:	set	0
 665                     ; 263   assert_param(IS_USART_CLOCK(USART_Clock));
 667                     ; 264   assert_param(IS_USART_CPOL(USART_CPOL));
 669                     ; 265   assert_param(IS_USART_CPHA(USART_CPHA));
 671                     ; 266   assert_param(IS_USART_LASTBIT(USART_LastBit));
 673                     ; 269   USARTx->CR3 &= (uint8_t)~(USART_CR3_CPOL | USART_CR3_CPHA | USART_CR3_LBCL);
 675  0084 e606          	ld	a,(6,x)
 676  0086 a4f8          	and	a,#248
 677  0088 e706          	ld	(6,x),a
 678                     ; 271   USARTx->CR3 |= (uint8_t)((uint8_t)((uint8_t)(USART_CPOL | (uint8_t)USART_CPHA ) | USART_LastBit));
 ...
 685                     ; 273   if (USART_Clock != USART_Clock_Disable)
 687  0094 0d05          	tnz	(OFST+5,sp)
 688  0096 2708          	jreq	L523
 689                     ; 275     USARTx->CR3 |= (uint8_t)(USART_CR3_CLKEN); /* Set the Clock Enable bit */
 691  0098 e606          	ld	a,(6,x)
 692  009a aa08          	or	a,#8
 693  009c e706          	ld	(6,x),a
 695  009e 2008          	jra	L723
 696  00a0               L523:
 697                     ; 279     USARTx->CR3 &= (uint8_t)(~USART_CR3_CLKEN); /* Clear the Clock Enable bit */
 ...
 707  00a8 85            	popw	x
 708  00a9 81            	ret
 775                     ; 290 void USART_Cmd(USART_TypeDef* USARTx, FunctionalState NewState)
 775                     ; 291 {
 776                     	switch	.text
 777  00aa               _USART_Cmd:
 779  00aa 89            	pushw	x
 780       00000000      OFST:	set	0
 783                     ; 292   if (NewState != DISABLE)
 785  00ab 0d05          	tnz	(OFST+5,sp)
 786  00ad 2708          	jreq	L563
 787                     ; 294     USARTx->CR1 &= (uint8_t)(~USART_CR1_USARTD); /**< USART Enable */
 789  00af e604          	ld	a,(4,x)
 790  00b1 a4df          	and	a,#223
 791  00b3 e704          	ld	(4,x),a
 793  00b5 2008          	jra	L763
 794  00b7               L563:
 795                     ; 298     USARTx->CR1 |= USART_CR1_USARTD;  /**< USART Disable (for low power consumption) */
 ...
 805  00bf 85            	popw	x
 806  00c0 81            	ret
 852                     ; 323 void USART_SetPrescaler(USART_TypeDef* USARTx, uint8_t USART_Prescaler)
 852                     ; 324 {
 853                     	switch	.text
 854  00c1               _USART_SetPrescaler:
 856  00c1 89            	pushw	x
 857       00000000      OFST:	set	0
 860                     ; 326   USARTx->PSCR = USART_Prescaler;
 ...
 868  00c8 85            	popw	x
 869  00c9 81            	ret
 906                     ; 334 void USART_SendBreak(USART_TypeDef* USARTx)
 906                     ; 335 {
 907                     	switch	.text
 908  00ca               _USART_SendBreak:
 912                     ; 336   USARTx->CR2 |= USART_CR2_SBK;
 914  00ca e605          	ld	a,(5,x)
 915  00cc aa01          	or	a,#1
 916  00ce e705          	ld	(5,x),a
 917                     ; 337 }
 920  00d0 81            	ret
 957                     ; 376 uint8_t USART_ReceiveData8(USART_TypeDef* USARTx)
 957                     ; 377 {
 958                     	switch	.text
 959  00d1               _USART_ReceiveData8:
 963                     ; 378   return USARTx->DR;
 965  00d1 e601          	ld	a,(1,x)
 968  00d3 81            	ret
1014                     ; 386 uint16_t USART_ReceiveData9(USART_TypeDef* USARTx)
1014                     ; 387 {
1015                     	switch	.text
...
1023                     ; 388   uint16_t temp = 0;
1025                     ; 390   temp = ((uint16_t)(((uint16_t)((uint16_t)USARTx->CR1 & (uint16_t)USART_CR1_R8)) << 1));
...
1035                     ; 391   return (uint16_t)( ((uint16_t)((uint16_t)USARTx->DR) | temp) & ((uint16_t)0x01FF));
...
1054  00f6 81            	ret
1100                     ; 399 void USART_SendData8(USART_TypeDef* USARTx, uint8_t Data)
1100                     ; 400 {
1101                     	switch	.text
1102  00f7               _USART_SendData8:
1104  00f7 89            	pushw	x
1105       00000000      OFST:	set	0
1108                     ; 402   USARTx->DR = Data;
...
1116  00fe 85            	popw	x
1117  00ff 81            	ret
1163                     ; 412 void USART_SendData9(USART_TypeDef* USARTx, uint16_t Data)
1163                     ; 413 {
1164                     	switch	.text
1165  0100               _USART_SendData9:
1167  0100 89            	pushw	x
1168       00000000      OFST:	set	0
1171                     ; 414   assert_param(IS_USART_DATA_9BITS(Data));
1173                     ; 417   USARTx->CR1 &= ((uint8_t)~USART_CR1_T8);
1175  0101 e604          	ld	a,(4,x)
1176  0103 a4bf          	and	a,#191
1177  0105 e704          	ld	(4,x),a
1178                     ; 420   USARTx->CR1 |= (uint8_t)(((uint8_t)(Data >> 2)) & USART_CR1_T8);
...
1187                     ; 423   USARTx->DR   = (uint8_t)(Data);
...
1195  011b 85            	popw	x
1196  011c 81            	ret
1244                     ; 467 void USART_ReceiverWakeUpCmd(USART_TypeDef* USARTx, FunctionalState NewState)
1244                     ; 468 {
1245                     	switch	.text
1246  011d               _USART_ReceiverWakeUpCmd:
1248  011d 89            	pushw	x
1249       00000000      OFST:	set	0
1252                     ; 469   assert_param(IS_FUNCTIONAL_STATE(NewState));
1254                     ; 471   if (NewState != DISABLE)
1256  011e 0d05          	tnz	(OFST+5,sp)
1257  0120 2708          	jreq	L575
1258                     ; 474     USARTx->CR2 |= USART_CR2_RWU;
1260  0122 e605          	ld	a,(5,x)
1261  0124 aa02          	or	a,#2
1262  0126 e705          	ld	(5,x),a
1264  0128 2008          	jra	L775
1265  012a               L575:
1266                     ; 479     USARTx->CR2 &= ((uint8_t)~USART_CR2_RWU);
...
1681  0195 85            	popw	x
1682  0196 81            	ret
1728                     ; 684 void USART_SetGuardTime(USART_TypeDef* USARTx, uint8_t USART_GuardTime)
1728                     ; 685 {
1729                     	switch	.text
1730  0197               _USART_SetGuardTime:
1732  0197 89            	pushw	x
1733       00000000      OFST:	set	0
1736                     ; 687   USARTx->GTR = USART_GuardTime;
...
1744  019e 85            	popw	x
1745  019f 81            	ret
1814                     ; 745 void USART_IrDAConfig(USART_TypeDef* USARTx, USART_IrDAMode_TypeDef USART_IrDAMode)
1814                     ; 746 {
1815                     	switch	.text
1816  01a0               _USART_IrDAConfig:
1818  01a0 89            	pushw	x
1819       00000000      OFST:	set	0
1822                     ; 747   assert_param(IS_USART_IRDAMODE(USART_IrDAMode));
1824                     ; 749   if (USART_IrDAMode != USART_IrDAMode_Normal)
1826  01a1 0d05          	tnz	(OFST+5,sp)
1827  01a3 2708          	jreq	L1501
1828                     ; 751     USARTx->CR5 |= USART_CR5_IRLP;
1830  01a5 e608          	ld	a,(8,x)
1831  01a7 aa04          	or	a,#4
1832  01a9 e708          	ld	(8,x),a
1834  01ab 2008          	jra	L3501
1835  01ad               L1501:
1836                     ; 755     USARTx->CR5 &= ((uint8_t)~USART_CR5_IRLP);
...
1846  01b5 85            	popw	x
1847  01b6 81            	ret
1894                     ; 766 void USART_IrDACmd(USART_TypeDef* USARTx, FunctionalState NewState)
1894                     ; 767 {
1895                     	switch	.text
1896  01b7               _USART_IrDACmd:
1898  01b7 89            	pushw	x
1899       00000000      OFST:	set	0
1902                     ; 770   assert_param(IS_FUNCTIONAL_STATE(NewState));
1904                     ; 772   if (NewState != DISABLE)
1906  01b8 0d05          	tnz	(OFST+5,sp)
1907  01ba 2708          	jreq	L1011
1908                     ; 775     USARTx->CR5 |= USART_CR5_IREN;
1910  01bc e608          	ld	a,(8,x)
1911  01be aa02          	or	a,#2
1912  01c0 e708          	ld	(8,x),a
1914  01c2 2008          	jra	L3011
1915  01c4               L1011:
1916                     ; 780     USARTx->CR5 &= ((uint8_t)~USART_CR5_IREN);
...
1926  01cc 85            	popw	x
1927  01cd 81            	ret
2004                     ; 812 void USART_DMACmd(USART_TypeDef* USARTx, USART_DMAReq_TypeDef USART_DMAReq,
2004                     ; 813                   FunctionalState NewState)
2004                     ; 814 {
2005                     	switch	.text
2006  01ce               _USART_DMACmd:
2008  01ce 89            	pushw	x
2009       00000000      OFST:	set	0
2012                     ; 816   assert_param(IS_USART_DMAREQ(USART_DMAReq));
2014                     ; 817   assert_param(IS_FUNCTIONAL_STATE(NewState));
2016                     ; 819   if (NewState != DISABLE)
2018  01cf 0d06          	tnz	(OFST+6,sp)
2019  01d1 2708          	jreq	L5411
2020                     ; 823     USARTx->CR5 |= (uint8_t) USART_DMAReq;
2022  01d3 e608          	ld	a,(8,x)
2023  01d5 1a05          	or	a,(OFST+5,sp)
2024  01d7 e708          	ld	(8,x),a
2026  01d9 2009          	jra	L7411
2027  01db               L5411:
2028                     ; 829     USARTx->CR5 &= (uint8_t)~USART_DMAReq;
...
2039  01e4 85            	popw	x
2040  01e5 81            	ret
2184                     ; 933 void USART_ITConfig(USART_TypeDef* USARTx, USART_IT_TypeDef USART_IT, FunctionalState NewState)
2184                     ; 934 {
2185                     	switch	.text
...
2193                     ; 935   uint8_t usartreg, itpos = 0x00;
2195                     ; 936   assert_param(IS_USART_CONFIG_IT(USART_IT));
2197                     ; 937   assert_param(IS_FUNCTIONAL_STATE(NewState));
2199                     ; 940   usartreg = (uint8_t)((uint16_t)USART_IT >> 0x08);
2201  01e8 7b07          	ld	a,(OFST+5,sp)
2202  01ea 6b01          	ld	(OFST-1,sp),a
2204                     ; 942   itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)USART_IT & (uint8_t)0x0F));
...
2289  024d               L7521:
2290                     ; 975       USARTx->CR2 &= (uint8_t)(~itpos);
...
2302  0258 81            	ret
2450                     ; 996 FlagStatus USART_GetFlagStatus(USART_TypeDef* USARTx, USART_FLAG_TypeDef USART_FLAG)
2450                     ; 997 {
2451                     	switch	.text
...
2579  028f 85            	popw	x
2580  0290 81            	ret
2683                     ; 1077 ITStatus USART_GetITStatus(USART_TypeDef* USARTx, USART_IT_TypeDef USART_IT)
2683                     ; 1078 {
2684                     	switch	.text
...
2692                     ; 1079   ITStatus pendingbitstatus = RESET;
2694                     ; 1080   uint8_t temp = 0;
2696                     ; 1081   uint8_t itpos = 0;
2698                     ; 1082   uint8_t itmask1 = 0;
2700                     ; 1083   uint8_t itmask2 = 0;
2702                     ; 1084   uint8_t enablestatus = 0;
2704                     ; 1087   assert_param(IS_USART_GET_IT(USART_IT));
2706                     ; 1090   itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)USART_IT & (uint8_t)0x0F));
...
2722                     ; 1092   itmask1 = (uint8_t)((uint8_t)USART_IT >> (uint8_t)4);
2724  02a5 7b09          	ld	a,(OFST+6,sp)
2725  02a7 4e            	swap	a
2726  02a8 a40f          	and	a,#15
2727  02aa 6b03          	ld	(OFST+0,sp),a
2729                     ; 1094   itmask2 = (uint8_t)((uint8_t)1 << itmask1);
...
2841                     ; 1143       pendingbitstatus = SET;
2843  0322 a601          	ld	a,#1
2844  0324 6b03          	ld	(OFST+0,sp),a
2847  0326 2002          	jra	L3741
2848  0328               L7051:
2849                     ; 1148       pendingbitstatus = RESET;
2851  0328 0f03          	clr	(OFST+0,sp)
2853  032a               L3741:
2854                     ; 1153   return  pendingbitstatus;
2856  032a 7b03          	ld	a,(OFST+0,sp)
2859  032c 5b05          	addw	sp,#5
2860  032e 81            	ret
2926                     ; 1178 void USART_ClearITPendingBit(USART_TypeDef* USARTx, USART_IT_TypeDef USART_IT)
2926                     ; 1179 {
2927                     	switch	.text
2928  032f               _USART_ClearITPendingBit:
2930  032f 89            	pushw	x
2931  0330 88            	push	a
2932       00000001      OFST:	set	1
2935                     ; 1180   uint8_t bitpos = 0x00, itmask = 0x00;
2939                     ; 1181   assert_param(IS_USART_CLEAR_IT(USART_IT));
2941                     ; 1182   bitpos = (uint8_t)( (uint8_t)((uint8_t)USART_IT & (uint8_t)0xF0) >> 0x04);
2943  0331 7b07          	ld	a,(OFST+6,sp)
2944  0333 a4f0          	and	a,#240
2945  0335 4e            	swap	a
2946  0336 a40f          	and	a,#15
2947  0338 6b01          	ld	(OFST+0,sp),a
2949                     ; 1183   itmask = (uint8_t)( (uint8_t)0x01 << bitpos);
2951  033a 7b01          	ld	a,(OFST+0,sp)
2952  033c 5f            	clrw	x
2953  033d 97            	ld	xl,a
2954  033e a601          	ld	a,#1
2955  0340 5d            	tnzw	x
2956  0341 2704          	jreq	L201
2957  0343               L401:
2958  0343 48            	sll	a
2959  0344 5a            	decw	x
2960  0345 26fc          	jrne	L401
2961  0347               L201:
2962  0347 6b01          	ld	(OFST+0,sp),a
2964                     ; 1185   USARTx->SR = (uint8_t)~itmask;
2966  0349 7b01          	ld	a,(OFST+0,sp)
2967  034b 43            	cpl	a
2968  034c 1e02          	ldw	x,(OFST+1,sp)
2969  034e f7            	ld	(x),a
2970                     ; 1186 }
2973  034f 5b03          	addw	sp,#3
2974  0351 81            	ret
2987                     	xdef	_USART_ClearITPendingBit
2988                     	xdef	_USART_GetITStatus
2989                     	xdef	_USART_ClearFlag
2990                     	xdef	_USART_GetFlagStatus
2991                     	xdef	_USART_ITConfig
2992                     	xdef	_USART_DMACmd
2993                     	xdef	_USART_IrDACmd
2994                     	xdef	_USART_IrDAConfig
2995                     	xdef	_USART_SetGuardTime
2996                     	xdef	_USART_SmartCardNACKCmd
2997                     	xdef	_USART_SmartCardCmd
2998                     	xdef	_USART_HalfDuplexCmd
2999                     	xdef	_USART_SetAddress
3000                     	xdef	_USART_ReceiverWakeUpCmd
3001                     	xdef	_USART_WakeUpConfig
3002                     	xdef	_USART_ReceiveData9
3003                     	xdef	_USART_ReceiveData8
3004                     	xdef	_USART_SendData9
3005                     	xdef	_USART_SendData8
3006                     	xdef	_USART_SendBreak
3007                     	xdef	_USART_SetPrescaler
3008                     	xdef	_USART_Cmd
3009                     	xdef	_USART_ClockInit
3010                     	xdef	_USART_Init
3011                     	xdef	_USART_DeInit
3012                     	xref	_CLK_GetClockFreq
3013                     	xref.b	c_lreg
3014                     	xref.b	c_x
3033                     	xref	c_lursh
3034                     	xref	c_ltor
