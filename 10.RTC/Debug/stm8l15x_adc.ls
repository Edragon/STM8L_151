 ...
 173                     ; 129 void ADC_DeInit(ADC_TypeDef* ADCx)
 173                     ; 130 {
 175                     	switch	.text
 176  0000               _ADC_DeInit:
 180                     ; 132   ADCx->CR1 =  ADC_CR1_RESET_VALUE;
 182  0000 7f            	clr	(x)
 183                     ; 133   ADCx->CR2 =  ADC_CR2_RESET_VALUE;
 185  0001 6f01          	clr	(1,x)
 186                     ; 134   ADCx->CR3 =  ADC_CR3_RESET_VALUE;
 188  0003 a61f          	ld	a,#31
 189  0005 e702          	ld	(2,x),a
 190                     ; 137   ADCx->SR =  (uint8_t)~ADC_SR_RESET_VALUE;
 192  0007 a6ff          	ld	a,#255
 193  0009 e703          	ld	(3,x),a
 194                     ; 140   ADCx->HTRH =  ADC_HTRH_RESET_VALUE;
 196  000b a60f          	ld	a,#15
 197  000d e706          	ld	(6,x),a
 198                     ; 141   ADCx->HTRL =  ADC_HTRL_RESET_VALUE;
 200  000f a6ff          	ld	a,#255
 201  0011 e707          	ld	(7,x),a
 202                     ; 144   ADCx->LTRH =  ADC_LTRH_RESET_VALUE;
 204  0013 6f08          	clr	(8,x)
 205                     ; 145   ADCx->LTRL =  ADC_LTRL_RESET_VALUE;
 207  0015 6f09          	clr	(9,x)
 208                     ; 148   ADCx->SQR[0] =  ADC_SQR1_RESET_VALUE;
 210  0017 6f0a          	clr	(10,x)
 211                     ; 149   ADCx->SQR[1] =  ADC_SQR2_RESET_VALUE;
 213  0019 6f0b          	clr	(11,x)
 214                     ; 150   ADCx->SQR[2] =  ADC_SQR3_RESET_VALUE;
 216  001b 6f0c          	clr	(12,x)
 217                     ; 151   ADCx->SQR[3] =  ADC_SQR4_RESET_VALUE;
 219  001d 6f0d          	clr	(13,x)
 220                     ; 154   ADCx->TRIGR[0] =  ADC_TRIGR1_RESET_VALUE;
 222  001f 6f0e          	clr	(14,x)
 223                     ; 155   ADCx->TRIGR[1] =  ADC_TRIGR2_RESET_VALUE;
 225  0021 6f0f          	clr	(15,x)
 226                     ; 156   ADCx->TRIGR[2] =  ADC_TRIGR3_RESET_VALUE;
 228  0023 6f10          	clr	(16,x)
 229                     ; 157   ADCx->TRIGR[3] =  ADC_TRIGR4_RESET_VALUE;
 231  0025 6f11          	clr	(17,x)
 232                     ; 158 }
 235  0027 81            	ret
 382                     ; 180 void ADC_Init(ADC_TypeDef* ADCx,
 382                     ; 181               ADC_ConversionMode_TypeDef ADC_ConversionMode,
 382                     ; 182               ADC_Resolution_TypeDef ADC_Resolution,
 382                     ; 183               ADC_Prescaler_TypeDef ADC_Prescaler)
 382                     ; 184 {
 383                     	switch	.text
 384  0028               _ADC_Init:
 386  0028 89            	pushw	x
 387       00000000      OFST:	set	0
 390                     ; 186   assert_param(IS_ADC_CONVERSION_MODE(ADC_ConversionMode));
 392                     ; 187   assert_param(IS_ADC_RESOLUTION(ADC_Resolution));
 394                     ; 188   assert_param(IS_ADC_PRESCALER(ADC_Prescaler));
 396                     ; 191   ADCx->CR1 &= (uint8_t)~(ADC_CR1_CONT | ADC_CR1_RES);
 398  0029 f6            	ld	a,(x)
 399  002a a49b          	and	a,#155
 400  002c f7            	ld	(x),a
 401                     ; 194   ADCx->CR1 |= (uint8_t)((uint8_t)ADC_ConversionMode | (uint8_t)ADC_Resolution);
 403  002d 7b05          	ld	a,(OFST+5,sp)
 404  002f 1a06          	or	a,(OFST+6,sp)
 405  0031 fa            	or	a,(x)
 406  0032 f7            	ld	(x),a
 407                     ; 197   ADCx->CR2 &= (uint8_t)~(ADC_CR2_PRESC);
 409  0033 e601          	ld	a,(1,x)
 410  0035 a47f          	and	a,#127
 411  0037 e701          	ld	(1,x),a
 412                     ; 200   ADCx->CR2 |= (uint8_t) ADC_Prescaler;
 ...
 420  003f 85            	popw	x
 421  0040 81            	ret
 488                     ; 210 void ADC_Cmd(ADC_TypeDef* ADCx,
 488                     ; 211              FunctionalState NewState)
 488                     ; 212 {
 489                     	switch	.text
 490  0041               _ADC_Cmd:
 492  0041 89            	pushw	x
 493       00000000      OFST:	set	0
 496                     ; 214   assert_param(IS_FUNCTIONAL_STATE(NewState));
 498                     ; 216   if (NewState != DISABLE)
 500  0042 0d05          	tnz	(OFST+5,sp)
 501  0044 2706          	jreq	L142
 502                     ; 219     ADCx->CR1 |= ADC_CR1_ADON;
 504  0046 f6            	ld	a,(x)
 505  0047 aa01          	or	a,#1
 506  0049 f7            	ld	(x),a
 508  004a 2006          	jra	L342
 509  004c               L142:
 510                     ; 224     ADCx->CR1 &= (uint8_t)~ADC_CR1_ADON;
 ...
 520  0052 85            	popw	x
 521  0053 81            	ret
 559                     ; 233 void ADC_SoftwareStartConv(ADC_TypeDef* ADCx)
 559                     ; 234 {
 560                     	switch	.text
 561  0054               _ADC_SoftwareStartConv:
 565                     ; 236   ADCx->CR1 |= ADC_CR1_START;
 567  0054 f6            	ld	a,(x)
 568  0055 aa02          	or	a,#2
 569  0057 f7            	ld	(x),a
 570                     ; 237 }
 573  0058 81            	ret
 701                     ; 255 void ADC_ExternalTrigConfig(ADC_TypeDef* ADCx,
 701                     ; 256                             ADC_ExtEventSelection_TypeDef ADC_ExtEventSelection,
 701                     ; 257                             ADC_ExtTRGSensitivity_TypeDef ADC_ExtTRGSensitivity)
 701                     ; 258 {
 702                     	switch	.text
 703  0059               _ADC_ExternalTrigConfig:
 705  0059 89            	pushw	x
 706       00000000      OFST:	set	0
 709                     ; 260   assert_param(IS_ADC_EXT_EVENT_SELECTION(ADC_ExtEventSelection));
 711                     ; 261   assert_param(IS_ADC_EXT_TRG_SENSITIVITY(ADC_ExtTRGSensitivity));
 713                     ; 264   ADCx->CR2 &= (uint8_t)~(ADC_CR2_TRIGEDGE | ADC_CR2_EXTSEL);
 715  005a e601          	ld	a,(1,x)
 716  005c a487          	and	a,#135
 717  005e e701          	ld	(1,x),a
 718                     ; 268   ADCx->CR2 |= (uint8_t)( (uint8_t)ADC_ExtTRGSensitivity | \
 718                     ; 269                           (uint8_t)ADC_ExtEventSelection);
 ...
 727  0068 85            	popw	x
 728  0069 81            	ret
1042                     ; 333 void ADC_AnalogWatchdogChannelSelect(ADC_TypeDef* ADCx,
1042                     ; 334                                      ADC_AnalogWatchdogSelection_TypeDef ADC_AnalogWatchdogSelection)
1042                     ; 335 {
1043                     	switch	.text
1044  006a               _ADC_AnalogWatchdogChannelSelect:
1046  006a 89            	pushw	x
1047       00000000      OFST:	set	0
1050                     ; 337   assert_param(IS_ADC_ANALOGWATCHDOG_SELECTION(ADC_AnalogWatchdogSelection));
1052                     ; 340   ADCx->CR3 &= ((uint8_t)~ADC_CR3_CHSEL);
1054  006b e602          	ld	a,(2,x)
1055  006d a4e0          	and	a,#224
1056  006f e702          	ld	(2,x),a
1057                     ; 343   ADCx->CR3 |= (uint8_t)ADC_AnalogWatchdogSelection;
...
1065  0077 85            	popw	x
1066  0078 81            	ret
1122                     ; 355 void ADC_AnalogWatchdogThresholdsConfig(ADC_TypeDef* ADCx, uint16_t HighThreshold, uint16_t LowThreshold)
1122                     ; 356 {
1123                     	switch	.text
1124  0079               _ADC_AnalogWatchdogThresholdsConfig:
1126  0079 89            	pushw	x
1127       00000000      OFST:	set	0
1130                     ; 358   assert_param(IS_ADC_THRESHOLD(HighThreshold));
1132                     ; 359   assert_param(IS_ADC_THRESHOLD(LowThreshold));
1134                     ; 362   ADCx->HTRH = (uint8_t)(HighThreshold >> 8);
1136  007a 7b05          	ld	a,(OFST+5,sp)
1137  007c 1e01          	ldw	x,(OFST+1,sp)
1138  007e e706          	ld	(6,x),a
1139                     ; 363   ADCx->HTRL = (uint8_t)(HighThreshold);
1141  0080 7b06          	ld	a,(OFST+6,sp)
1142  0082 1e01          	ldw	x,(OFST+1,sp)
1143  0084 e707          	ld	(7,x),a
1144                     ; 366   ADCx->LTRH = (uint8_t)(LowThreshold >> 8);
1146  0086 7b07          	ld	a,(OFST+7,sp)
1147  0088 1e01          	ldw	x,(OFST+1,sp)
1148  008a e708          	ld	(8,x),a
1149                     ; 367   ADCx->LTRL = (uint8_t)(LowThreshold);
...
1157  0092 85            	popw	x
1158  0093 81            	ret
1225                     ; 406 void ADC_AnalogWatchdogConfig(ADC_TypeDef* ADCx,
1225                     ; 407                               ADC_AnalogWatchdogSelection_TypeDef ADC_AnalogWatchdogSelection,
1225                     ; 408                               uint16_t HighThreshold,
1225                     ; 409                               uint16_t LowThreshold)
1225                     ; 410 {
1226                     	switch	.text
1227  0094               _ADC_AnalogWatchdogConfig:
1229  0094 89            	pushw	x
1230       00000000      OFST:	set	0
1233                     ; 412   assert_param(IS_ADC_ANALOGWATCHDOG_SELECTION(ADC_AnalogWatchdogSelection));
1235                     ; 413   assert_param(IS_ADC_THRESHOLD(HighThreshold));
1237                     ; 414   assert_param(IS_ADC_THRESHOLD(LowThreshold));
1239                     ; 417   ADCx->CR3 &= ((uint8_t)~ADC_CR3_CHSEL);
1241  0095 e602          	ld	a,(2,x)
1242  0097 a4e0          	and	a,#224
1243  0099 e702          	ld	(2,x),a
1244                     ; 420   ADCx->CR3 |= (uint8_t)ADC_AnalogWatchdogSelection;
1246  009b e602          	ld	a,(2,x)
1247  009d 1a05          	or	a,(OFST+5,sp)
1248  009f e702          	ld	(2,x),a
1249                     ; 423   ADCx->HTRH = (uint8_t)(HighThreshold >> 8);
1251  00a1 7b06          	ld	a,(OFST+6,sp)
1252  00a3 1e01          	ldw	x,(OFST+1,sp)
1253  00a5 e706          	ld	(6,x),a
1254                     ; 424   ADCx->HTRL = (uint8_t)(HighThreshold);
1256  00a7 7b07          	ld	a,(OFST+7,sp)
1257  00a9 1e01          	ldw	x,(OFST+1,sp)
1258  00ab e707          	ld	(7,x),a
1259                     ; 427   ADCx->LTRH = (uint8_t)(LowThreshold >> 8);
1261  00ad 7b08          	ld	a,(OFST+8,sp)
1262  00af 1e01          	ldw	x,(OFST+1,sp)
1263  00b1 e708          	ld	(8,x),a
1264                     ; 428   ADCx->LTRL = (uint8_t)LowThreshold;
...
1272  00b9 85            	popw	x
1273  00ba 81            	ret
1308                     ; 468 void ADC_TempSensorCmd(FunctionalState NewState)
1308                     ; 469 {
1309                     	switch	.text
1310  00bb               _ADC_TempSensorCmd:
1314                     ; 471   assert_param(IS_FUNCTIONAL_STATE(NewState));
1316                     ; 473   if (NewState != DISABLE)
1318  00bb 4d            	tnz	a
1319  00bc 2706          	jreq	L175
1320                     ; 476     ADC1->TRIGR[0] |= (uint8_t)(ADC_TRIGR1_TSON);
1322  00be 721a534e      	bset	21326,#5
1324  00c2 2004          	jra	L375
1325  00c4               L175:
1326                     ; 481     ADC1->TRIGR[0] &= (uint8_t)(~ADC_TRIGR1_TSON);
1328  00c4 721b534e      	bres	21326,#5
1329  00c8               L375:
1330                     ; 483 }
1333  00c8 81            	ret
1368                     ; 491 void ADC_VrefintCmd(FunctionalState NewState)
1368                     ; 492 {
1369                     	switch	.text
1370  00c9               _ADC_VrefintCmd:
1374                     ; 494   assert_param(IS_FUNCTIONAL_STATE(NewState));
1376                     ; 496   if (NewState != DISABLE)
1378  00c9 4d            	tnz	a
1379  00ca 2706          	jreq	L316
1380                     ; 499     ADC1->TRIGR[0] |= (uint8_t)(ADC_TRIGR1_VREFINTON);
1382  00cc 7218534e      	bset	21326,#4
1384  00d0 2004          	jra	L516
1385  00d2               L316:
1386                     ; 504     ADC1->TRIGR[0] &= (uint8_t)(~ADC_TRIGR1_VREFINTON);
1388  00d2 7219534e      	bres	21326,#4
1389  00d6               L516:
1390                     ; 506 }
1393  00d6 81            	ret
1705                     ; 577 void ADC_ChannelCmd(ADC_TypeDef* ADCx, ADC_Channel_TypeDef ADC_Channels, FunctionalState NewState)
1705                     ; 578 {
1706                     	switch	.text
...
1714                     ; 579   uint8_t regindex = 0;
1716                     ; 581   assert_param(IS_FUNCTIONAL_STATE(NewState));
1718                     ; 583   regindex = (uint8_t)((uint16_t)ADC_Channels >> 8);
1720  00d9 7b06          	ld	a,(OFST+5,sp)
1721  00db 6b01          	ld	(OFST+0,sp),a
1723                     ; 585   if (NewState != DISABLE)
1725  00dd 0d08          	tnz	(OFST+7,sp)
1726  00df 270f          	jreq	L367
1727                     ; 588     ADCx->SQR[regindex] |= (uint8_t)(ADC_Channels);
...
1740  00f0               L367:
1741                     ; 593     ADCx->SQR[regindex] &= (uint8_t)(~(uint8_t)(ADC_Channels));
...
1760  0104 81            	ret
1910                     ; 619 void ADC_SamplingTimeConfig(ADC_TypeDef* ADCx,
1910                     ; 620                             ADC_Group_TypeDef ADC_GroupChannels,
1910                     ; 621                             ADC_SamplingTime_TypeDef ADC_SamplingTime)
1910                     ; 622 {
1911                     	switch	.text
1912  0105               _ADC_SamplingTimeConfig:
1914  0105 89            	pushw	x
1915       00000000      OFST:	set	0
1918                     ; 624   assert_param(IS_ADC_GROUP(ADC_GroupChannels));
1920                     ; 625   assert_param(IS_ADC_SAMPLING_TIME_CYCLES(ADC_SamplingTime));
1922                     ; 627   if ( ADC_GroupChannels != ADC_Group_SlowChannels)
1924  0106 0d05          	tnz	(OFST+5,sp)
1925  0108 2712          	jreq	L3501
1926                     ; 630     ADCx->CR3 &= (uint8_t)~ADC_CR3_SMPT2;
1928  010a e602          	ld	a,(2,x)
1929  010c a41f          	and	a,#31
1930  010e e702          	ld	(2,x),a
1931                     ; 631     ADCx->CR3 |= (uint8_t)(ADC_SamplingTime << 5);
...
1958  012c 85            	popw	x
1959  012d 81            	ret
2026                     ; 685 void ADC_SchmittTriggerConfig(ADC_TypeDef* ADCx, ADC_Channel_TypeDef ADC_Channels,
2026                     ; 686                               FunctionalState NewState)
2026                     ; 687 {
2027                     	switch	.text
...
2035                     ; 688   uint8_t regindex = 0;
2037                     ; 690   assert_param(IS_FUNCTIONAL_STATE(NewState));
2039                     ; 692   regindex = (uint8_t)((uint16_t)ADC_Channels >> 8);
2041  0130 7b06          	ld	a,(OFST+5,sp)
2042  0132 6b01          	ld	(OFST+0,sp),a
2044                     ; 694   if (NewState != DISABLE)
2046  0134 0d08          	tnz	(OFST+7,sp)
2047  0136 2710          	jreq	L3111
2048                     ; 697     ADCx->TRIGR[regindex] &= (uint8_t)(~(uint8_t)ADC_Channels);
...
2062  0148               L3111:
2063                     ; 702     ADCx->TRIGR[regindex] |= (uint8_t)(ADC_Channels);
...
2081  015b 81            	ret
2128                     ; 711 uint16_t ADC_GetConversionValue(ADC_TypeDef* ADCx)
2128                     ; 712 {
2129                     	switch	.text
...
2137                     ; 713   uint16_t tmpreg = 0;
2139                     ; 716   tmpreg = (uint16_t)(ADCx->DRH);
2141  015e e604          	ld	a,(4,x)
2142  0160 5f            	clrw	x
2143  0161 97            	ld	xl,a
2144  0162 1f01          	ldw	(OFST-1,sp),x
2146                     ; 717   tmpreg = (uint16_t)((uint16_t)((uint16_t)tmpreg << 8) | ADCx->DRL);
...
2239  0188 85            	popw	x
2240  0189 81            	ret
2324                     ; 825 void ADC_ITConfig(ADC_TypeDef* ADCx, ADC_IT_TypeDef ADC_IT, FunctionalState NewState)
2324                     ; 826 {
2325                     	switch	.text
2326  018a               _ADC_ITConfig:
2328  018a 89            	pushw	x
2329       00000000      OFST:	set	0
2332                     ; 828   assert_param(IS_FUNCTIONAL_STATE(NewState));
2334                     ; 829   assert_param(IS_ADC_IT(ADC_IT));
2336                     ; 831   if (NewState != DISABLE)
2338  018b 0d06          	tnz	(OFST+6,sp)
2339  018d 2706          	jreq	L5321
2340                     ; 834     ADCx->CR1 |= (uint8_t) ADC_IT;
2342  018f f6            	ld	a,(x)
2343  0190 1a05          	or	a,(OFST+5,sp)
2344  0192 f7            	ld	(x),a
2346  0193 2007          	jra	L7321
2347  0195               L5321:
2348                     ; 839     ADCx->CR1 &= (uint8_t)(~ADC_IT);
...
2359  019c 85            	popw	x
2360  019d 81            	ret
2465                     ; 853 FlagStatus ADC_GetFlagStatus(ADC_TypeDef* ADCx, ADC_FLAG_TypeDef ADC_FLAG)
2465                     ; 854 {
2466                     	switch	.text
...
2474                     ; 855   FlagStatus flagstatus = RESET;
2476                     ; 858   assert_param(IS_ADC_GET_FLAG(ADC_FLAG));
2478                     ; 861   if ((ADCx->SR & ADC_FLAG) != (uint8_t)RESET)
2480  01a0 e603          	ld	a,(3,x)
2481  01a2 1506          	bcp	a,(OFST+5,sp)
2482  01a4 2706          	jreq	L3131
2483                     ; 864     flagstatus = SET;
2485  01a6 a601          	ld	a,#1
2486  01a8 6b01          	ld	(OFST+0,sp),a
2489  01aa 2002          	jra	L5131
2490  01ac               L3131:
2491                     ; 869     flagstatus = RESET;
2493  01ac 0f01          	clr	(OFST+0,sp)
2495  01ae               L5131:
2496                     ; 873   return  flagstatus;
2498  01ae 7b01          	ld	a,(OFST+0,sp)
2501  01b0 5b03          	addw	sp,#3
2502  01b2 81            	ret
2549                     ; 886 void ADC_ClearFlag(ADC_TypeDef* ADCx,
2549                     ; 887                    ADC_FLAG_TypeDef ADC_FLAG)
2549                     ; 888 {
2550                     	switch	.text
2551  01b3               _ADC_ClearFlag:
2553  01b3 89            	pushw	x
2554       00000000      OFST:	set	0
2557                     ; 890   assert_param(IS_ADC_CLEAR_FLAG(ADC_FLAG));
2559                     ; 893   ADCx->SR = (uint8_t)~ADC_FLAG;
...
2568  01bb 85            	popw	x
2569  01bc 81            	ret
2645                     ; 906 ITStatus ADC_GetITStatus(ADC_TypeDef* ADCx,
2645                     ; 907                          ADC_IT_TypeDef ADC_IT)
2645                     ; 908 {
2646                     	switch	.text
...
2654                     ; 909   ITStatus itstatus = RESET;
2656                     ; 910   uint8_t itmask = 0, enablestatus = 0;
...
2670                     ; 917   itmask =  (uint8_t)((uint8_t)((uint8_t)(itmask & (uint8_t)0x10) >> 2) | \
2670                     ; 918                                 (uint8_t)(itmask & (uint8_t)0x03));
...
2683                     ; 921   enablestatus = (uint8_t)(ADCx->CR1 & (uint8_t)ADC_IT) ;
2685  01d7 f6            	ld	a,(x)
2686  01d8 1408          	and	a,(OFST+5,sp)
2687  01da 6b02          	ld	(OFST-1,sp),a
2689                     ; 924   if (((ADCx->SR & itmask) != (uint8_t)RESET) && enablestatus)
...
2782                     ; 952   uint8_t itmask = 0;
2784                     ; 955   assert_param(IS_ADC_IT(ADC_IT));
2786                     ; 958   itmask = (uint8_t)(ADC_IT >> 3);
2788  01f5 7b07          	ld	a,(OFST+5,sp)
2789  01f7 44            	srl	a
2790  01f8 44            	srl	a
2791  01f9 44            	srl	a
2792  01fa 6b02          	ld	(OFST+0,sp),a
2794                     ; 959   itmask =  (uint8_t)((uint8_t)(((uint8_t)(itmask & (uint8_t)0x10)) >> 2) | \
2794                     ; 960                                  (uint8_t)(itmask & (uint8_t)0x03));
...
2807                     ; 963   ADCx->SR = (uint8_t)~itmask;
