 ...
 637                     ; 82     LCD_WriteRAM(LCD_RAMRegister_11,(LCD_DisBuffer[3]<<4)|0x40);//2P,COM3，SEG10对应RAM的第7位，所以要与0X40相或
 639  024a b60d          	ld	a,_LCD_DisBuffer+3
 640  024c 97            	ld	xl,a
 641  024d a610          	ld	a,#16
 642  024f 42            	mul	x,a
 643  0250 9f            	ld	a,xl
 644  0251 aa40          	or	a,#64
 645  0253 97            	ld	xl,a
 646  0254 a60b          	ld	a,#11
 647  0256 95            	ld	xh,a
 648  0257 cd0000        	call	_LCD_WriteRAM
 650                     ; 85 }
 653  025a 81            	ret
 733                     	switch	.ubsct
 734  0000               _n4:
 ...
 736                     	xdef	_n4
 737  0002               _n3:
 738  0002 0000          	ds.b	2
 739                     	xdef	_n3
 740  0004               _n2:
 741  0004 0000          	ds.b	2
 742                     	xdef	_n2
 743  0006               _n1:
 744  0006 0000          	ds.b	2
 745                     	xdef	_n1
 746  0008               _tmp:
 747  0008 0000          	ds.b	2
 748                     	xdef	_tmp
 749                     	xdef	_NumberMap
 750  000a               _LCD_DisBuffer:
 751  000a 00000000      	ds.b	4
 752                     	xdef	_LCD_DisBuffer
 753                     	xdef	_Display_lcd_dot
 754                     	xdef	_Display
 755                     	xdef	_data_convertor
 756                     	xdef	_InitLCD
 757                     	xref	_LCD_WriteRAM
 758                     	xref	_LCD_ContrastConfig
 759                     	xref	_LCD_DeadTimeConfig
 760                     	xref	_LCD_PulseOnDurationConfig
 761                     	xref	_LCD_Cmd
 762                     	xref	_LCD_PortMaskConfig
 763                     	xref	_LCD_Init
 764                     	xref	_LCD_DeInit
 765                     	xref	_CLK_PeripheralClockConfig
 766                     	xref	_CLK_RTCClockConfig
 786                     	end
