 ...
 198                     ; 135 void I2C_DeInit(I2C_TypeDef* I2Cx)
 198                     ; 136 {
 200                     	switch	.text
 201  0000               _I2C_DeInit:
 205                     ; 137   I2Cx->CR1 = I2C_CR1_RESET_VALUE;
 207  0000 7f            	clr	(x)
 208                     ; 138   I2Cx->CR2 = I2C_CR2_RESET_VALUE;
 210  0001 6f01          	clr	(1,x)
 211                     ; 139   I2Cx->FREQR = I2C_FREQR_RESET_VALUE;
 213  0003 6f02          	clr	(2,x)
 214                     ; 140   I2Cx->OARL = I2C_OARL_RESET_VALUE;
 216  0005 6f03          	clr	(3,x)
 217                     ; 141   I2Cx->OARH = I2C_OARH_RESET_VALUE;
 219  0007 6f04          	clr	(4,x)
 220                     ; 142   I2Cx->OAR2 = I2C_OAR2_RESET_VALUE;
 222  0009 6f05          	clr	(5,x)
 223                     ; 143   I2Cx->ITR = I2C_ITR_RESET_VALUE;
 225  000b 6f0a          	clr	(10,x)
 226                     ; 144   I2Cx->CCRL = I2C_CCRL_RESET_VALUE;
 228  000d 6f0b          	clr	(11,x)
 229                     ; 145   I2Cx->CCRH = I2C_CCRH_RESET_VALUE;
 231  000f 6f0c          	clr	(12,x)
 232                     ; 146   I2Cx->TRISER = I2C_TRISER_RESET_VALUE;
 ...
 470                     ; 178 void I2C_Init(I2C_TypeDef* I2Cx, uint32_t OutputClockFrequency, uint16_t OwnAddress,
 470                     ; 179               I2C_Mode_TypeDef I2C_Mode, I2C_DutyCycle_TypeDef I2C_DutyCycle,
 470                     ; 180               I2C_Ack_TypeDef I2C_Ack, I2C_AcknowledgedAddress_TypeDef I2C_AcknowledgedAddress)
 470                     ; 181 {
 471                     	switch	.text
 472  0016               _I2C_Init:
 474  0016 89            	pushw	x
 ...
 479                     ; 182   uint32_t result = 0x0004;
 481                     ; 183   uint16_t tmpval = 0;
 483                     ; 184   uint8_t tmpccrh = 0;
 485  0019 0f07          	clr	(OFST-5,sp)
 487                     ; 185   uint8_t input_clock = 0;
 489                     ; 188   assert_param(IS_I2C_MODE(I2C_Mode));
 491                     ; 189   assert_param(IS_I2C_ACK_STATE(I2C_Ack));
 493                     ; 190   assert_param(IS_I2C_ACKNOWLEDGE_ADDRESS(I2C_AcknowledgedAddress));
 495                     ; 191   assert_param(IS_I2C_DUTY_CYCLE(I2C_DutyCycle));
 497                     ; 192   assert_param(IS_I2C_OWN_ADDRESS(OwnAddress));
 499                     ; 193   assert_param(IS_I2C_OUTPUT_CLOCK_FREQ(OutputClockFrequency));
 501                     ; 197   input_clock = (uint8_t) (CLK_GetClockFreq() / 1000000);
 ...
 550  005c               L61:
 551                     ; 217     tmpccrh = I2C_CCRH_FS;
 553  005c a680          	ld	a,#128
 554  005e 6b07          	ld	(OFST-5,sp),a
 556                     ; 219     if (I2C_DutyCycle == I2C_DutyCycle_2)
 558  0060 0d18          	tnz	(OFST+12,sp)
 559  0062 2633          	jrne	L562
 560                     ; 222       result = (uint32_t) ((input_clock * 1000000) / (OutputClockFrequency * 3));
 ...
 593  0097               L562:
 594                     ; 227       result = (uint32_t) ((input_clock * 1000000) / (OutputClockFrequency * 25));
 ...
 659                     ; 243     I2Cx->TRISER = (uint8_t)tmpval;
 661  00ef 7b06          	ld	a,(OFST-6,sp)
 662  00f1 1e0d          	ldw	x,(OFST+1,sp)
 663  00f3 e70d          	ld	(13,x),a
 665  00f5 205c          	jra	L372
 666  00f7               L362:
 667                     ; 250     result = (uint16_t)((input_clock * 1000000) / (OutputClockFrequency << (uint8_t)1));
 ...
 704                     ; 253     if (result < (uint16_t)0x0004)
 ...
 778  018d 81            	ret
 845                     ; 289 void I2C_Cmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
 845                     ; 290 {
 846                     	switch	.text
 847  018e               _I2C_Cmd:
 849  018e 89            	pushw	x
 850       00000000      OFST:	set	0
 853                     ; 293   assert_param(IS_FUNCTIONAL_STATE(NewState));
 855                     ; 295   if (NewState != DISABLE)
 857  018f 0d05          	tnz	(OFST+5,sp)
 858  0191 2706          	jreq	L333
 859                     ; 298     I2Cx->CR1 |= I2C_CR1_PE;
 861  0193 f6            	ld	a,(x)
 862  0194 aa01          	or	a,#1
 863  0196 f7            	ld	(x),a
 865  0197 2006          	jra	L533
 866  0199               L333:
 867                     ; 303     I2Cx->CR1 &= (uint8_t)(~I2C_CR1_PE);
 ...
 877  019f 85            	popw	x
 878  01a0 81            	ret
 925                     ; 314 void I2C_GeneralCallCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
 925                     ; 315 {
 926                     	switch	.text
 927  01a1               _I2C_GeneralCallCmd:
 929  01a1 89            	pushw	x
 930       00000000      OFST:	set	0
 933                     ; 318   assert_param(IS_FUNCTIONAL_STATE(NewState));
 935                     ; 320   if (NewState != DISABLE)
 937  01a2 0d05          	tnz	(OFST+5,sp)
 938  01a4 2706          	jreq	L363
 939                     ; 323     I2Cx->CR1 |= I2C_CR1_ENGC;
 941  01a6 f6            	ld	a,(x)
 942  01a7 aa40          	or	a,#64
 943  01a9 f7            	ld	(x),a
 945  01aa 2006          	jra	L563
 946  01ac               L363:
 947                     ; 328     I2Cx->CR1 &= (uint8_t)(~I2C_CR1_ENGC);
 ...
 957  01b2 85            	popw	x
 958  01b3 81            	ret
1005                     ; 341 void I2C_GenerateSTART(I2C_TypeDef* I2Cx, FunctionalState NewState)
1005                     ; 342 {
1006                     	switch	.text
1007  01b4               _I2C_GenerateSTART:
1009  01b4 89            	pushw	x
1010       00000000      OFST:	set	0
1013                     ; 345   assert_param(IS_FUNCTIONAL_STATE(NewState));
1015                     ; 347   if (NewState != DISABLE)
1017  01b5 0d05          	tnz	(OFST+5,sp)
1018  01b7 2708          	jreq	L314
1019                     ; 350     I2Cx->CR2 |= I2C_CR2_START;
1021  01b9 e601          	ld	a,(1,x)
1022  01bb aa01          	or	a,#1
1023  01bd e701          	ld	(1,x),a
1025  01bf 2008          	jra	L514
1026  01c1               L314:
1027                     ; 355     I2Cx->CR2 &= (uint8_t)(~I2C_CR2_START);
...
1037  01c9 85            	popw	x
1038  01ca 81            	ret
1085                     ; 366 void I2C_GenerateSTOP(I2C_TypeDef* I2Cx, FunctionalState NewState)
1085                     ; 367 {
1086                     	switch	.text
1087  01cb               _I2C_GenerateSTOP:
1089  01cb 89            	pushw	x
1090       00000000      OFST:	set	0
1093                     ; 370   assert_param(IS_FUNCTIONAL_STATE(NewState));
1095                     ; 372   if (NewState != DISABLE)
1097  01cc 0d05          	tnz	(OFST+5,sp)
1098  01ce 2708          	jreq	L344
1099                     ; 375     I2Cx->CR2 |= I2C_CR2_STOP;
1101  01d0 e601          	ld	a,(1,x)
1102  01d2 aa02          	or	a,#2
1103  01d4 e701          	ld	(1,x),a
1105  01d6 2008          	jra	L544
1106  01d8               L344:
1107                     ; 380     I2Cx->CR2 &= (uint8_t)(~I2C_CR2_STOP);
...
1117  01e0 85            	popw	x
1118  01e1 81            	ret
1166                     ; 391 void I2C_SoftwareResetCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
1166                     ; 392 {
1167                     	switch	.text
1168  01e2               _I2C_SoftwareResetCmd:
1170  01e2 89            	pushw	x
1171       00000000      OFST:	set	0
1174                     ; 394   assert_param(IS_FUNCTIONAL_STATE(NewState));
1176                     ; 396   if (NewState != DISABLE)
1178  01e3 0d05          	tnz	(OFST+5,sp)
1179  01e5 2708          	jreq	L374
1180                     ; 399     I2Cx->CR2 |= I2C_CR2_SWRST;
1182  01e7 e601          	ld	a,(1,x)
1183  01e9 aa80          	or	a,#128
1184  01eb e701          	ld	(1,x),a
1186  01ed 2008          	jra	L574
1187  01ef               L374:
1188                     ; 404     I2Cx->CR2 &= (uint8_t)(~I2C_CR2_SWRST);
...
1198  01f7 85            	popw	x
1199  01f8 81            	ret
1247                     ; 415 void I2C_StretchClockCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
1247                     ; 416 {
1248                     	switch	.text
1249  01f9               _I2C_StretchClockCmd:
1251  01f9 89            	pushw	x
1252       00000000      OFST:	set	0
1255                     ; 418   assert_param(IS_FUNCTIONAL_STATE(NewState));
1257                     ; 420   if (NewState != DISABLE)
1259  01fa 0d05          	tnz	(OFST+5,sp)
1260  01fc 2706          	jreq	L325
1261                     ; 423     I2Cx->CR1 &= (uint8_t)(~I2C_CR1_NOSTRETCH);
1263  01fe f6            	ld	a,(x)
1264  01ff a47f          	and	a,#127
1265  0201 f7            	ld	(x),a
1267  0202 2006          	jra	L525
1268  0204               L325:
1269                     ; 429     I2Cx->CR1 |= I2C_CR1_NOSTRETCH;
...
1279  020a 85            	popw	x
1280  020b 81            	ret
1327                     ; 440 void I2C_ARPCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
1327                     ; 441 {
1328                     	switch	.text
1329  020c               _I2C_ARPCmd:
1331  020c 89            	pushw	x
1332       00000000      OFST:	set	0
1335                     ; 443   assert_param(IS_FUNCTIONAL_STATE(NewState));
1337                     ; 445   if (NewState != DISABLE)
1339  020d 0d05          	tnz	(OFST+5,sp)
1340  020f 2706          	jreq	L355
1341                     ; 448     I2Cx->CR1 |= I2C_CR1_ARP;
1343  0211 f6            	ld	a,(x)
1344  0212 aa10          	or	a,#16
1345  0214 f7            	ld	(x),a
1347  0215 2006          	jra	L555
1348  0217               L355:
1349                     ; 454     I2Cx->CR1 &= (uint8_t)(~I2C_CR1_ARP);
...
1359  021d 85            	popw	x
1360  021e 81            	ret
1408                     ; 465 void I2C_AcknowledgeConfig(I2C_TypeDef* I2Cx, FunctionalState NewState)
1408                     ; 466 {
1409                     	switch	.text
1410  021f               _I2C_AcknowledgeConfig:
1412  021f 89            	pushw	x
1413       00000000      OFST:	set	0
1416                     ; 468   assert_param(IS_FUNCTIONAL_STATE(NewState));
1418                     ; 470   if (NewState != DISABLE)
1420  0220 0d05          	tnz	(OFST+5,sp)
1421  0222 2708          	jreq	L306
1422                     ; 473     I2Cx->CR2 |= I2C_CR2_ACK;
1424  0224 e601          	ld	a,(1,x)
1425  0226 aa04          	or	a,#4
1426  0228 e701          	ld	(1,x),a
1428  022a 2008          	jra	L506
1429  022c               L306:
1430                     ; 478     I2Cx->CR2 &= (uint8_t)(~I2C_CR2_ACK);
...
1440  0234 85            	popw	x
1441  0235 81            	ret
1497                     ; 488 void I2C_OwnAddress2Config(I2C_TypeDef* I2Cx, uint8_t Address)
1497                     ; 489 {
1498                     	switch	.text
...
1535  0252 81            	ret
1582                     ; 512 void I2C_DualAddressCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
1582                     ; 513 {
1583                     	switch	.text
1584  0253               _I2C_DualAddressCmd:
1586  0253 89            	pushw	x
1587       00000000      OFST:	set	0
1590                     ; 515   assert_param(IS_FUNCTIONAL_STATE(NewState));
1592                     ; 517   if (NewState != DISABLE)
1594  0254 0d05          	tnz	(OFST+5,sp)
1595  0256 2708          	jreq	L366
1596                     ; 520     I2Cx->OAR2 |= I2C_OAR2_ENDUAL;
1598  0258 e605          	ld	a,(5,x)
1599  025a aa01          	or	a,#1
1600  025c e705          	ld	(5,x),a
1602  025e 2008          	jra	L566
1603  0260               L366:
1604                     ; 525     I2Cx->OAR2 &= (uint8_t)(~I2C_OAR2_ENDUAL);
...
1614  0268 85            	popw	x
1615  0269 81            	ret
1685                     ; 539 void I2C_AckPositionConfig(I2C_TypeDef* I2Cx, I2C_AckPosition_TypeDef I2C_AckPosition)
1685                     ; 540 {
1686                     	switch	.text
1687  026a               _I2C_AckPositionConfig:
1689  026a 89            	pushw	x
1690       00000000      OFST:	set	0
1693                     ; 542   assert_param(IS_I2C_ACK_POSITION(I2C_AckPosition));
1695                     ; 545   I2Cx->CR2 &= (uint8_t)(~I2C_CR2_POS);
1697  026b e601          	ld	a,(1,x)
1698  026d a4f7          	and	a,#247
1699  026f e701          	ld	(1,x),a
1700                     ; 547   I2Cx->CR2 |= (uint8_t)I2C_AckPosition;
...
1708  0277 85            	popw	x
1709  0278 81            	ret
1778                     ; 559 void I2C_SMBusAlertConfig(I2C_TypeDef* I2Cx, I2C_SMBusAlert_TypeDef I2C_SMBusAlert)
1778                     ; 560 {
1779                     	switch	.text
1780  0279               _I2C_SMBusAlertConfig:
1782  0279 89            	pushw	x
1783       00000000      OFST:	set	0
1786                     ; 563   assert_param(IS_I2C_SMBUS_ALERT(I2C_SMBusAlert));
1788                     ; 565   if (I2C_SMBusAlert != I2C_SMBusAlert_High)
1790  027a 0d05          	tnz	(OFST+5,sp)
1791  027c 2708          	jreq	L757
1792                     ; 568     I2Cx->CR2 |= (uint8_t)I2C_CR2_ALERT;
1794  027e e601          	ld	a,(1,x)
1795  0280 aa20          	or	a,#32
1796  0282 e701          	ld	(1,x),a
1798  0284 2008          	jra	L167
1799  0286               L757:
1800                     ; 573     I2Cx->CR2 &= (uint8_t)(~I2C_CR2_ALERT);
...
1810  028e 85            	popw	x
1811  028f 81            	ret
1859                     ; 586 void I2C_FastModeDutyCycleConfig(I2C_TypeDef* I2Cx, I2C_DutyCycle_TypeDef I2C_DutyCycle)
1859                     ; 587 {
1860                     	switch	.text
1861  0290               _I2C_FastModeDutyCycleConfig:
1863  0290 89            	pushw	x
1864       00000000      OFST:	set	0
1867                     ; 590   assert_param(IS_I2C_DUTY_CYCLE(I2C_DutyCycle));
1869                     ; 592   if (I2C_DutyCycle == I2C_DutyCycle_16_9)
1871  0291 7b05          	ld	a,(OFST+5,sp)
1872  0293 a140          	cp	a,#64
1873  0295 2608          	jrne	L7001
1874                     ; 595     I2Cx->CCRH |= I2C_CCRH_DUTY;
1876  0297 e60c          	ld	a,(12,x)
1877  0299 aa40          	or	a,#64
1878  029b e70c          	ld	(12,x),a
1880  029d 2008          	jra	L1101
1881  029f               L7001:
1882                     ; 600     I2Cx->CCRH &= (uint8_t)(~I2C_CCRH_DUTY);
...
1892  02a7 85            	popw	x
1893  02a8 81            	ret
1972                     ; 615 void I2C_Send7bitAddress(I2C_TypeDef* I2Cx, uint8_t Address, I2C_Direction_TypeDef I2C_Direction)
1972                     ; 616 {
1973                     	switch	.text
1974  02a9               _I2C_Send7bitAddress:
1976  02a9 89            	pushw	x
1977       00000000      OFST:	set	0
1980                     ; 618   assert_param(IS_I2C_ADDRESS(Address));
1982                     ; 619   assert_param(IS_I2C_DIRECTION(I2C_Direction));
1984                     ; 622   if (I2C_Direction != I2C_Direction_Transmitter)
1986  02aa 0d06          	tnz	(OFST+6,sp)
1987  02ac 2708          	jreq	L3501
1988                     ; 625     Address |= OAR1_ADD0_Set;
1990  02ae 7b05          	ld	a,(OFST+5,sp)
1991  02b0 aa01          	or	a,#1
1992  02b2 6b05          	ld	(OFST+5,sp),a
1994  02b4 2006          	jra	L5501
1995  02b6               L3501:
1996                     ; 630     Address &= OAR1_ADD0_Reset;
1998  02b6 7b05          	ld	a,(OFST+5,sp)
1999  02b8 a4fe          	and	a,#254
2000  02ba 6b05          	ld	(OFST+5,sp),a
2001  02bc               L5501:
2002                     ; 633   I2Cx->DR = Address;
...
2010  02c2 85            	popw	x
2011  02c3 81            	ret
2057                     ; 658 void I2C_SendData(I2C_TypeDef* I2Cx, uint8_t Data)
2057                     ; 659 {
2058                     	switch	.text
2059  02c4               _I2C_SendData:
2061  02c4 89            	pushw	x
2062       00000000      OFST:	set	0
2065                     ; 661   I2Cx->DR = Data;
...
2073  02cb 85            	popw	x
2074  02cc 81            	ret
2111                     ; 670 uint8_t I2C_ReceiveData(I2C_TypeDef* I2Cx)
2111                     ; 671 {
2112                     	switch	.text
2113  02cd               _I2C_ReceiveData:
2117                     ; 673   return ((uint8_t)I2Cx->DR);
2119  02cd e606          	ld	a,(6,x)
2122  02cf 81            	ret
2169                     ; 699 void I2C_TransmitPEC(I2C_TypeDef* I2Cx, FunctionalState NewState)
2169                     ; 700 {
2170                     	switch	.text
2171  02d0               _I2C_TransmitPEC:
2173  02d0 89            	pushw	x
2174       00000000      OFST:	set	0
2177                     ; 702   assert_param(IS_FUNCTIONAL_STATE(NewState));
2179                     ; 704   if (NewState != DISABLE)
2181  02d1 0d05          	tnz	(OFST+5,sp)
2182  02d3 2708          	jreq	L7411
2183                     ; 707     I2Cx->CR2 |= I2C_CR2_PEC;
2185  02d5 e601          	ld	a,(1,x)
2186  02d7 aa10          	or	a,#16
2187  02d9 e701          	ld	(1,x),a
2189  02db 2008          	jra	L1511
2190  02dd               L7411:
2191                     ; 712     I2Cx->CR2 &= (uint8_t)(~I2C_CR2_PEC);
...
2201  02e5 85            	popw	x
2202  02e6 81            	ret
2249                     ; 723 void I2C_CalculatePEC(I2C_TypeDef* I2Cx, FunctionalState NewState)
2249                     ; 724 {
2250                     	switch	.text
2251  02e7               _I2C_CalculatePEC:
2253  02e7 89            	pushw	x
2254       00000000      OFST:	set	0
2257                     ; 726   assert_param(IS_FUNCTIONAL_STATE(NewState));
2259                     ; 728   if (NewState != DISABLE)
2261  02e8 0d05          	tnz	(OFST+5,sp)
2262  02ea 2706          	jreq	L7711
2263                     ; 731     I2Cx->CR1 |= I2C_CR1_ENPEC;
2265  02ec f6            	ld	a,(x)
2266  02ed aa20          	or	a,#32
2267  02ef f7            	ld	(x),a
2269  02f0 2006          	jra	L1021
2270  02f2               L7711:
2271                     ; 736     I2Cx->CR1 &= (uint8_t)(~I2C_CR1_ENPEC);
...
2281  02f8 85            	popw	x
2282  02f9 81            	ret
2352                     ; 749 void I2C_PECPositionConfig(I2C_TypeDef* I2Cx, I2C_PECPosition_TypeDef I2C_PECPosition)
2352                     ; 750 {
2353                     	switch	.text
2354  02fa               _I2C_PECPositionConfig:
2356  02fa 89            	pushw	x
2357       00000000      OFST:	set	0
2360                     ; 752   assert_param(IS_I2C_PEC_POSITION(I2C_PECPosition));
2362                     ; 755   I2Cx->CR2 &= (uint8_t)(~I2C_CR2_POS);
2364  02fb e601          	ld	a,(1,x)
2365  02fd a4f7          	and	a,#247
2366  02ff e701          	ld	(1,x),a
2367                     ; 757   I2Cx->CR2 |= (uint8_t)I2C_PECPosition;
...
2375  0307 85            	popw	x
2376  0308 81            	ret
2413                     ; 766 uint8_t I2C_GetPEC(I2C_TypeDef* I2Cx)
2413                     ; 767 {
2414                     	switch	.text
2415  0309               _I2C_GetPEC:
2419                     ; 769   return (I2Cx->PECR);
2421  0309 e60e          	ld	a,(14,x)
2424  030b 81            	ret
2471                     ; 797 void I2C_DMACmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
2471                     ; 798 {
2472                     	switch	.text
2473  030c               _I2C_DMACmd:
2475  030c 89            	pushw	x
2476       00000000      OFST:	set	0
2479                     ; 800   assert_param(IS_FUNCTIONAL_STATE(NewState));
2481                     ; 802   if (NewState != DISABLE)
2483  030d 0d05          	tnz	(OFST+5,sp)
2484  030f 2708          	jreq	L3031
2485                     ; 805     I2Cx->ITR |= I2C_ITR_DMAEN;
2487  0311 e60a          	ld	a,(10,x)
2488  0313 aa08          	or	a,#8
2489  0315 e70a          	ld	(10,x),a
2491  0317 2008          	jra	L5031
2492  0319               L3031:
2493                     ; 810     I2Cx->ITR &= (uint8_t)(~I2C_ITR_DMAEN);
...
2503  0321 85            	popw	x
2504  0322 81            	ret
2552                     ; 821 void I2C_DMALastTransferCmd(I2C_TypeDef* I2Cx, FunctionalState NewState)
2552                     ; 822 {
2553                     	switch	.text
2554  0323               _I2C_DMALastTransferCmd:
2556  0323 89            	pushw	x
2557       00000000      OFST:	set	0
2560                     ; 824   assert_param(IS_FUNCTIONAL_STATE(NewState));
2562                     ; 826   if (NewState != DISABLE)
2564  0324 0d05          	tnz	(OFST+5,sp)
2565  0326 2708          	jreq	L3331
2566                     ; 829     I2Cx->ITR |= I2C_ITR_LAST;
2568  0328 e60a          	ld	a,(10,x)
2569  032a aa10          	or	a,#16
2570  032c e70a          	ld	(10,x),a
2572  032e 2008          	jra	L5331
2573  0330               L3331:
2574                     ; 834     I2Cx->ITR &= (uint8_t)(~I2C_ITR_LAST);
...
2584  0338 85            	popw	x
2585  0339 81            	ret
2774                     ; 948 void I2C_ITConfig(I2C_TypeDef* I2Cx, I2C_IT_TypeDef I2C_IT, FunctionalState NewState)
2774                     ; 949 {
2775                     	switch	.text
2776  033a               _I2C_ITConfig:
2778  033a 89            	pushw	x
2779       00000000      OFST:	set	0
2782                     ; 951   assert_param(IS_I2C_CONFIG_IT(I2C_IT));
2784                     ; 952   assert_param(IS_FUNCTIONAL_STATE(NewState));
2786                     ; 954   if (NewState != DISABLE)
2788  033b 0d07          	tnz	(OFST+7,sp)
2789  033d 2708          	jreq	L7341
2790                     ; 957     I2Cx->ITR |= (uint8_t)I2C_IT;
2792  033f e60a          	ld	a,(10,x)
2793  0341 1a06          	or	a,(OFST+6,sp)
2794  0343 e70a          	ld	(10,x),a
2796  0345 2009          	jra	L1441
2797  0347               L7341:
2798                     ; 962     I2Cx->ITR &= (uint8_t)(~(uint8_t)I2C_IT);
...
2809  0350 85            	popw	x
2810  0351 81            	ret
2971                     ; 988 uint8_t I2C_ReadRegister(I2C_TypeDef* I2Cx, I2C_Register_TypeDef I2C_Register)
2971                     ; 989 {
2972                     	switch	.text
...
2980                     ; 990   __IO uint16_t tmp = 0;
2982  0355 5f            	clrw	x
2983  0356 1f03          	ldw	(OFST-1,sp),x
2985                     ; 992   assert_param(IS_I2C_REGISTER(I2C_Register));
2987                     ; 994   tmp = (uint16_t) I2Cx;
2989  0358 1e05          	ldw	x,(OFST+1,sp)
2990  035a 1f03          	ldw	(OFST-1,sp),x
2992                     ; 995   tmp += I2C_Register;
...
3003                     ; 998   return (*(__IO uint8_t *) tmp);
3005  0369 1e03          	ldw	x,(OFST-1,sp)
3006  036b f6            	ld	a,(x)
3009  036c 5b06          	addw	sp,#6
3010  036e 81            	ret
3264                     ; 1038 ErrorStatus I2C_CheckEvent(I2C_TypeDef* I2Cx, I2C_Event_TypeDef I2C_Event)
3264                     ; 1039 {
3265                     	switch	.text
...
3273                     ; 1040   __IO uint16_t lastevent = 0x00;
3275  0372 5f            	clrw	x
3276  0373 1f04          	ldw	(OFST-2,sp),x
3278                     ; 1041   uint8_t flag1 = 0x00 ;
3280                     ; 1042   uint8_t flag2 = 0x00;
3282                     ; 1043   ErrorStatus status = ERROR;
3284                     ; 1046   assert_param(IS_I2C_EVENT(I2C_Event));
3286                     ; 1048   if (I2C_Event == I2C_EVENT_SLAVE_ACK_FAILURE)
3288  0375 1e0b          	ldw	x,(OFST+5,sp)
3289  0377 a30004        	cpw	x,#4
3290  037a 260c          	jrne	L5561
3291                     ; 1050     lastevent = I2Cx->SR2 & I2C_SR2_AF;
...
3334  03a9               L7561:
3335                     ; 1059   if (((uint16_t)lastevent & (uint16_t)I2C_Event) == (uint16_t)I2C_Event)
...
3489  03f5               L3271:
3490                     ; 1109   return (I2C_Event_TypeDef)lastevent;
3492  03f5 1e05          	ldw	x,(OFST-1,sp)
3495  03f7 5b08          	addw	sp,#8
3496  03f9 81            	ret
3753                     ; 1146 FlagStatus I2C_GetFlagStatus(I2C_TypeDef* I2Cx, I2C_FLAG_TypeDef I2C_FLAG)
3753                     ; 1147 {
3754                     	switch	.text
...
3762                     ; 1148   uint8_t tempreg = 0;
3764  03fc 0f02          	clr	(OFST+0,sp)
3766                     ; 1149   uint8_t regindex = 0;
3768                     ; 1150   FlagStatus bitstatus = RESET;
3770                     ; 1153   assert_param(IS_I2C_GET_FLAG(I2C_FLAG));
3772                     ; 1156   regindex = (uint8_t)((uint16_t)I2C_FLAG >> 8);
3774  03fe 7b07          	ld	a,(OFST+5,sp)
3775  0400 6b01          	ld	(OFST-1,sp),a
3777                     ; 1158   switch (regindex)
...
3789  040f               L5271:
3790                     ; 1161     case 0x01:
3790                     ; 1162       tempreg = (uint8_t)I2Cx->SR1;
...
3799  0417               L7271:
3800                     ; 1166     case 0x02:
3800                     ; 1167       tempreg = (uint8_t)I2Cx->SR2;
...
3809  041f               L1371:
3810                     ; 1171     case 0x03:
3810                     ; 1172       tempreg = (uint8_t)I2Cx->SR3;
...
3911                     ; 1225   uint16_t flagpos = 0;
3913                     ; 1227   assert_param(IS_I2C_CLEAR_FLAG(I2C_FLAG));
3915                     ; 1230   flagpos = (uint16_t)I2C_FLAG & FLAG_Mask;
...
3926                     ; 1232   I2Cx->SR2 = (uint8_t)((uint16_t)(~flagpos));
...
3936  044f 81            	ret
4012                     ; 1258 ITStatus I2C_GetITStatus(I2C_TypeDef* I2Cx, I2C_IT_TypeDef I2C_IT)
4012                     ; 1259 {
4013                     	switch	.text
...
4021                     ; 1260   ITStatus bitstatus = RESET;
4023                     ; 1261   __IO uint8_t enablestatus = 0;
4025  0453 0f03          	clr	(OFST-1,sp)
4027                     ; 1262   uint16_t tempregister = 0;
4029                     ; 1265   assert_param(IS_I2C_GET_IT(I2C_IT));
4031                     ; 1267   tempregister = (uint8_t)( ((uint16_t)((uint16_t)I2C_IT & ITEN_Mask)) >> 8);
4033  0455 7b09          	ld	a,(OFST+5,sp)
4034  0457 a407          	and	a,#7
4035  0459 5f            	clrw	x
4036  045a 97            	ld	xl,a
4037  045b 1f01          	ldw	(OFST-3,sp),x
4039                     ; 1270   enablestatus = (uint8_t)(I2Cx->ITR & ( uint8_t)tempregister);
4041  045d 1e05          	ldw	x,(OFST+1,sp)
4042  045f e60a          	ld	a,(10,x)
4043  0461 1402          	and	a,(OFST-2,sp)
4044  0463 6b03          	ld	(OFST-1,sp),a
4046                     ; 1272   if ((uint16_t)((uint16_t)I2C_IT & REGISTER_Mask) == REGISTER_SR1_Index)
...
4058                     ; 1275     if (((I2Cx->SR1 & (uint8_t)I2C_IT) != RESET) && enablestatus)
...
4175                     ; 1336   uint16_t flagpos = 0;
4177                     ; 1339   assert_param(IS_I2C_CLEAR_IT(I2C_IT));
4179                     ; 1342   flagpos = (uint16_t)I2C_IT & FLAG_Mask;
...
4190                     ; 1345   I2Cx->SR2 = (uint8_t)((uint16_t)~flagpos);
