  ...
  42                     ; 117 void EXTI_DeInit(void)
  42                     ; 118 {
  44                     	switch	.text
  45  0000               _EXTI_DeInit:
  49                     ; 119   EXTI->CR1 = EXTI_CR1_RESET_VALUE;
  51  0000 725f50a0      	clr	20640
  52                     ; 120   EXTI->CR2 = EXTI_CR2_RESET_VALUE;
  54  0004 725f50a1      	clr	20641
  55                     ; 121   EXTI->CR3 = EXTI_CR3_RESET_VALUE;
  57  0008 725f50a2      	clr	20642
  58                     ; 122   EXTI->CR4 = EXTI_CR4_RESET_VALUE;
  60  000c 725f50aa      	clr	20650
  61                     ; 123   EXTI->SR1 = 0xFF; /* Setting SR1 bits in order to clear flags */
  63  0010 35ff50a3      	mov	20643,#255
  64                     ; 124   EXTI->SR2 = 0xFF; /* Setting SR2 bits in order to clear flags */
  66  0014 35ff50a4      	mov	20644,#255
  67                     ; 125   EXTI->CONF1 = EXTI_CONF1_RESET_VALUE;
  69  0018 725f50a5      	clr	20645
  70                     ; 126   EXTI->CONF2 = EXTI_CONF2_RESET_VALUE;
  72  001c 725f50ab      	clr	20651
  73                     ; 127 }
  76  0020 81            	ret
 222                     ; 154 void EXTI_SetPinSensitivity(EXTI_Pin_TypeDef EXTI_Pin, EXTI_Trigger_TypeDef EXTI_Trigger)
 222                     ; 155 {
 223                     	switch	.text
 224  0021               _EXTI_SetPinSensitivity:
 226  0021 89            	pushw	x
 227       00000000      OFST:	set	0
 230                     ; 158   assert_param(IS_EXTI_PINNUM(EXTI_Pin));
 232                     ; 159   assert_param(IS_EXTI_TRIGGER(EXTI_Trigger));
 234                     ; 162   switch (EXTI_Pin)
 236  0022 9e            	ld	a,xh
 238                     ; 196     default:
 238                     ; 197       break;
 239  0023 4d            	tnz	a
 ...
 264  0055               L12:
 265                     ; 164     case EXTI_Pin_0:
 265                     ; 165       EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P0IS);
 267  0055 c650a0        	ld	a,20640
 268  0058 a4fc          	and	a,#252
 269  005a c750a0        	ld	20640,a
 270                     ; 166       EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
 ...
 288  0074               L32:
 289                     ; 168     case EXTI_Pin_1:
 289                     ; 169       EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P1IS);
 291  0074 c650a0        	ld	a,20640
 292  0077 a4f3          	and	a,#243
 293  0079 c750a0        	ld	20640,a
 294                     ; 170       EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
 ...
 312  0093               L52:
 313                     ; 172     case EXTI_Pin_2:
 313                     ; 173       EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P2IS);
 315  0093 c650a0        	ld	a,20640
 316  0096 a4cf          	and	a,#207
 317  0098 c750a0        	ld	20640,a
 318                     ; 174       EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
 ...
 336  00b2               L72:
 337                     ; 176     case EXTI_Pin_3:
 337                     ; 177       EXTI->CR1 &=  (uint8_t)(~EXTI_CR1_P3IS);
 339  00b2 c650a0        	ld	a,20640
 340  00b5 a43f          	and	a,#63
 341  00b7 c750a0        	ld	20640,a
 342                     ; 178       EXTI->CR1 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Pin);
 ...
 360  00cf               L13:
 361                     ; 180     case EXTI_Pin_4:
 361                     ; 181       EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P4IS);
 363  00cf c650a1        	ld	a,20641
 364  00d2 a4fc          	and	a,#252
 365  00d4 c750a1        	ld	20641,a
 366                     ; 182       EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
 ...
 385  00ee               L33:
 386                     ; 184     case EXTI_Pin_5:
 386                     ; 185       EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P5IS);
 388  00ee c650a1        	ld	a,20641
 389  00f1 a4f3          	and	a,#243
 390  00f3 c750a1        	ld	20641,a
 391                     ; 186       EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
 ...
 410  010d               L53:
 411                     ; 188     case EXTI_Pin_6:
 411                     ; 189       EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P6IS);
 413  010d c650a1        	ld	a,20641
 414  0110 a4cf          	and	a,#207
 415  0112 c750a1        	ld	20641,a
 416                     ; 190       EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
 ...
 435  012c               L73:
 436                     ; 192     case EXTI_Pin_7:
 436                     ; 193       EXTI->CR2 &=  (uint8_t)(~EXTI_CR2_P7IS);
 438  012c c650a1        	ld	a,20641
 439  012f a43f          	and	a,#63
 440  0131 c750a1        	ld	20641,a
 441                     ; 194       EXTI->CR2 |= (uint8_t)((uint8_t)(EXTI_Trigger) << ((uint8_t)EXTI_Pin & (uint8_t)0xEF));
 ...
 826  01aa               L103:
 827                     ; 296     if (NewState != DISABLE)
 829  01aa 0d02          	tnz	(OFST+2,sp)
 830  01ac 270c          	jreq	L113
 831                     ; 299       EXTI->CONF2 |= (uint8_t)(EXTI_HalfPort & (uint8_t)0x7F);
 ...
 839  01ba               L113:
 840                     ; 304       EXTI->CONF2 &= (uint8_t)(~(uint8_t) (EXTI_HalfPort & (uint8_t)0x7F));
 ...
 851  01c5 85            	popw	x
 852  01c6 81            	ret
 898                     ; 332 void EXTI_SetPortSensitivity(EXTI_Port_TypeDef EXTI_Port,
 898                     ; 333                              EXTI_Trigger_TypeDef EXTI_Trigger)
 898                     ; 334 {
 899                     	switch	.text
 900  01c7               _EXTI_SetPortSensitivity:
 902  01c7 89            	pushw	x
 903       00000000      OFST:	set	0
 906                     ; 336   assert_param(IS_EXTI_PORT(EXTI_Port));
 908                     ; 337   assert_param(IS_EXTI_TRIGGER(EXTI_Trigger));
 910                     ; 340   if ((EXTI_Port & 0xF0) == 0x00)
 912  01c8 9e            	ld	a,xh
 913  01c9 a5f0          	bcp	a,#240
 914  01cb 2629          	jrne	L733
 915                     ; 343     EXTI->CR3 &= (uint8_t) (~(uint8_t)((uint8_t)0x03 << EXTI_Port));
 ...
 931                     ; 345     EXTI->CR3 |= (uint8_t)((uint8_t)(EXTI_Trigger) << EXTI_Port);
 ...
 948  01f6               L733:
 949                     ; 350     EXTI->CR4 &= (uint8_t) (~(uint8_t)((uint8_t)0x03 << (EXTI_Port & 0x0F)));
 ...
 966                     ; 352     EXTI->CR4 |= (uint8_t)(EXTI_Trigger << (EXTI_Port & 0x0F));
 ...
 986  0221 85            	popw	x
 987  0222 81            	ret
1033                     ; 370 EXTI_Trigger_TypeDef EXTI_GetPinSensitivity(EXTI_Pin_TypeDef EXTI_Pin)
1033                     ; 371 {
1034                     	switch	.text
1035  0223               _EXTI_GetPinSensitivity:
1037  0223 88            	push	a
1038       00000001      OFST:	set	1
1041                     ; 372   uint8_t value = 0;
1043  0224 0f01          	clr	(OFST+0,sp)
1045                     ; 375   assert_param(IS_EXTI_PINNUM(EXTI_Pin));
1047                     ; 377   switch (EXTI_Pin)
1050                     ; 403     default:
1050                     ; 404       break;
1051  0226 4d            	tnz	a
...
1068  0247               L343:
1069                     ; 379     case EXTI_Pin_0:
1069                     ; 380       value = (uint8_t)(EXTI->CR1 & EXTI_CR1_P0IS);
...
1078  0250               L543:
1079                     ; 382     case EXTI_Pin_1:
1079                     ; 383       value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_P1IS) >> EXTI_Pin_1);
...
1090  025b               L743:
1091                     ; 385     case EXTI_Pin_2:
1091                     ; 386       value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_P2IS) >> EXTI_Pin_2);
...
1102  0267               L153:
1103                     ; 388     case EXTI_Pin_3:
1103                     ; 389       value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_P3IS) >> EXTI_Pin_3);
...
1116  0275               L353:
1117                     ; 391     case EXTI_Pin_4:
1117                     ; 392       value = (uint8_t)(EXTI->CR2 & EXTI_CR2_P4IS);
...
1126  027e               L553:
1127                     ; 394     case EXTI_Pin_5:
1127                     ; 395       value = (uint8_t)((uint8_t)(EXTI->CR2 & EXTI_CR2_P5IS) >> ((uint8_t)EXTI_Pin_5 & (uint8_t)0x0F));
...
1138  0289               L753:
1139                     ; 397     case EXTI_Pin_6:
1139                     ; 398       value = (uint8_t)((uint8_t)(EXTI->CR2 & EXTI_CR2_P6IS) >> ((uint8_t)EXTI_Pin_6 & (uint8_t)0x0F));
...
1150  0295               L163:
1151                     ; 400     case EXTI_Pin_7:
1151                     ; 401       value = (uint8_t)((uint8_t)(EXTI->CR2 & EXTI_CR2_P7IS) >> ((uint8_t)EXTI_Pin_7 & (uint8_t)0x0F));
...
1164                     ; 404       break;
1166  02a1               L114:
1167                     ; 406   return((EXTI_Trigger_TypeDef)value);
1169  02a1 7b01          	ld	a,(OFST+0,sp)
1172  02a3 5b01          	addw	sp,#1
1173  02a5 81            	ret
1219                     ; 421 EXTI_Trigger_TypeDef EXTI_GetPortSensitivity(EXTI_Port_TypeDef EXTI_Port)
1219                     ; 422 {
1220                     	switch	.text
...
1228                     ; 423   uint8_t portsensitivity = 0;
1230                     ; 426   assert_param(IS_EXTI_PORT(EXTI_Port));
1232                     ; 429   if ((EXTI_Port & 0xF0) == 0x00)
1234  02a8 a5f0          	bcp	a,#240
1235  02aa 2614          	jrne	L534
1236                     ; 432     portsensitivity = (uint8_t)((uint8_t)0x03 & (uint8_t)(EXTI->CR3 >> EXTI_Port));
...
1254  02c0               L534:
1255                     ; 438     portsensitivity = (uint8_t)((uint8_t)0x03 & (uint8_t)(EXTI->CR4 >> (EXTI_Port & 0x0F)));
...
1272  02d4               L734:
1273                     ; 441   return((EXTI_Trigger_TypeDef)portsensitivity);
1275  02d4 7b01          	ld	a,(OFST+0,sp)
1278  02d6 85            	popw	x
1279  02d7 81            	ret
1449                     ; 481 ITStatus EXTI_GetITStatus(EXTI_IT_TypeDef EXTI_IT)
1449                     ; 482 {
1450                     	switch	.text
...
1458                     ; 483   ITStatus status = RESET;
1460                     ; 485   assert_param(IS_EXTI_ITPENDINGBIT(EXTI_IT));
1462                     ; 487   if (((uint16_t)EXTI_IT & (uint16_t)0xFF00) == 0x0100)
...
1472                     ; 489     status = (ITStatus)(EXTI->SR2 & (uint8_t)((uint16_t)EXTI_IT & (uint16_t)0x00FF));
...
1481  02f1               L335:
1482                     ; 493     status = (ITStatus)(EXTI->SR1 & ((uint8_t)((uint16_t)EXTI_IT & (uint16_t)0x00FF)));
1484  02f1 7b03          	ld	a,(OFST+2,sp)
1485  02f3 a4ff          	and	a,#255
1486  02f5 c450a3        	and	a,20643
1487  02f8 6b01          	ld	(OFST+0,sp),a
1489  02fa               L535:
1490                     ; 495   return((ITStatus)status);
1492  02fa 7b01          	ld	a,(OFST+0,sp)
1495  02fc 5b03          	addw	sp,#3
1496  02fe 81            	ret
1541                     ; 518 void EXTI_ClearITPendingBit(EXTI_IT_TypeDef EXTI_IT)
1541                     ; 519 {
1542                     	switch	.text
...
1550                     ; 520   uint16_t tempvalue = 0;
1552                     ; 523   assert_param(IS_EXTI_ITPENDINGBIT(EXTI_IT));
1554                     ; 525   tempvalue = ((uint16_t)EXTI_IT & (uint16_t)0xFF00);
